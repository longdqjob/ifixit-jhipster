...
insert  into `jhi_persistent_audit_event`(`event_id`,`principal`,`event_date`,`event_type`) values (1,'admin','2017-10-06 12:42:27','AUTHENTICATION_SUCCESS'),(2,'admin','2017-10-06 12:42:27','AUTHENTICATION_SUCCESS'),(3,'admin','2017-10-06 14:19:33','AUTHENTICATION_SUCCESS'),(4,'admin','2017-10-09 15:56:16','AUTHENTICATION_SUCCESS'),(5,'admin','2017-10-09 15:57:33','AUTHENTICATION_SUCCESS'),(6,'admin','2017-10-09 15:58:29','AUTHENTICATION_SUCCESS'),(7,'admin','2017-10-09 16:00:59','AUTHENTICATION_SUCCESS'),(8,'admin','2017-10-09 17:05:58','AUTHENTICATION_SUCCESS');
...
insert  into `jhi_user`(`id`,`login`,`password_hash`,`first_name`,`last_name`,`email`,`image_url`,`activated`,`lang_key`,`activation_key`,`reset_key`,`created_by`,`created_date`,`reset_date`,`last_modified_by`,`last_modified_date`,`company_id`) values (1,'system','$2a$10$mE.qmcV0mFU5NcKh73TZx.z4ueI/.bDWbj0T1BYyqP481kGGarKLG','System','System','system@localhost','','','vi',NULL,NULL,'system','2017-10-06 12:41:26',NULL,'system',NULL,NULL),(2,'anonymoususer','$2a$10$j8S5d7Sr7.8VTOYNviDPOeWX8KcYILUVJBsYV83Y5NtECayypx9lO','Anonymous','User','anonymous@localhost','','','vi',NULL,NULL,'system','2017-10-06 12:41:26',NULL,'system',NULL,NULL),(3,'admin','$2a$10$gSAhZrxMllrbgj/kkK9UceBPpChGWJA7SYIb1Mqo.n5aNLq1/oRrC','Administrator','Administrator','admin@localhost','','','vi',NULL,NULL,'system','2017-10-06 12:41:26',NULL,'system',NULL,2),(4,'user','$2a$10$VEjxo0jq2YG9Rbk2HmX9S.k1uZBGYUHdUcid3g/vfiEl7lwWgOH/K','User','User','user@localhost','','','vi',NULL,NULL,'system','2017-10-06 12:41:26',NULL,'system',NULL,NULL),(5,'thuyetlv','$2a$10$wkeFMph5FlvuTvWr5xyXd.LF3hEFcx0d/tSyl005GRxWFtZPss7ka','thuyet','le','lethuyet.10.11.1990@gmail.com',NULL,'','vi',NULL,'85119224876599055755','admin','2017-10-10 16:07:51','2017-10-10 16:07:51','admin','2017-10-10 16:07:51',NULL);
